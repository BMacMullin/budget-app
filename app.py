...
st.write("Complete this form on your phone, download the PDF, and email it to your representative.")
...
# 3. PDF Engine (Must be outside the 'with st.form' block)
if submitted:
    pdf = FPDF()
    pdf.add_page()
    ...
    mailto_link = f"mailto:iande@goldhar.ca?subject={email_subject}&body=Hi,%0D%0A%0D%0APlease find my report for {report_date.strftime('%B %Y')} attached."
